 ...
 * @author yessi
 */
public class InformationTabView extends VBox{
    ...
    public InformationTabView(){
        ...
        list.setMargin(hyperlink1, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink2, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink3, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink4, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink5, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink6, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink7, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink8, new Insets(0, 0, 20, 0));
        list.setMargin(hyperlink9, new Insets(0, 0, 20, 0));
    }
